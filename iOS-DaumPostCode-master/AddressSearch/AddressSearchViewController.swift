...
class AddressSearchViewController: UIViewController, ResultCellDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    func doSearchAddress(keyword: String, page: Int) {
        ...
        let headers: HTTPHeaders = [
            "Authorization": "KakaoAK q4VMBcWCA5mI_Sr09jHtptm2-ocCtbOd9E1lyAopcNEAAAF1Pm-PUA"
            //"Authorization": "http://www.juso.go.kr/addrlink/addrLinkApi.do"
        ]
        
        let parameters: [String: Any] = [
            //"confmKey": "devU01TX0FVVEgyMDIwMTAxNjEwNDIyNzExMDI5NjE=",
            //"currentPage": "1",
            //"countPerPage": "10",
            //"keyword": keyword,
            //"resultType": "json"
        ...
        print("OK")
        AF.request("https://dapi.kakao.com/v2/lovak/search/address.json", method: .get, parameters: parameters, headers: headers)
